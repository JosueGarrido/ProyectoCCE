...
const SearchCores = props => {
    ...
    return (
        ...
        >
            ...
            <TreeNode value="parent 1" title={<b className="textSearch">SEDE NACIONAL</b>}>
                <TreeNode value="parent 1-0" title={< div className="textSearch">PRESIDENCIA NACIONAL</div>}>
            ...
            <TreeNode value="parent 2" title={<b className="textSearch">DIRECCIÓN DE FOMENTO ARTÍSTICO Y CULTURAL</b>}>
            ...
            <TreeNode value="parent 3" title={<b className="textSearch">NÚCLEO DE AZUAY</b>}>
            ...
            <TreeNode value="parent 4" title={<b className="textSearch">NÚCLEO DE BOLÍVAR</b>}>
            ...
            <TreeNode value="parent 5" title={<b className="textSearch">NÚCLEO DE CAÑAR</b>}>
            ...
            <TreeNode value="parent 6" title={<b className="textSearch">NÚCLEO DEL CARCHI</b>}>
            ...
            <TreeNode value="parent 7" title={<b className="textSearch">NÚCLEO DE COTOPAXI</b>}>
            ...
            <TreeNode value="parent 8" title={<b className="textSearch">NÚCLEO DE CHIMBORAZO</b>}>
            ...
            <TreeNode value="parent 9" title={<b className="textSearch">NÚCLEO DE EL ORO</b>}>
            ...
            <TreeNode value="parent 10" title={<b className="textSearch">NÚCLEO DE ESMERALDAS</b>}>
            ...
            <TreeNode value="parent 11" title={<b className="textSearch">NÚCLEO DE GALÁPAGOS</b>}>
            ...
            <TreeNode value="parent 12" title={<b className="textSearch">NÚCLEO DE GUAYAS</b>}>
            ...
            <TreeNode value="parent 13" title={<b className="textSearch">NÚCLEO DE IMBABURA</b>}>
            ...
            <TreeNode value="parent 14" title={<b className="textSearch">NÚCLEO DE LOJA</b>}>
            ...
            <TreeNode value="parent 15" title={<b className="textSearch">NÚCLEO DE LOS RIOS</b>}>
            ...
            <TreeNode value="parent 16" title={<b className="textSearch">NÚCLEO DE MANABI </b>}>
            ...
            <TreeNode value="parent 17" title={<b className="textSearch">NÚCLEO DE MORONA SANTIAGO </b>}>
            ...
            <TreeNode value="parent 18" title={<b className="textSearch">NÚCLEO DE NAPO</b>}>
            ...
            <TreeNode value="parent 19" title={<b className="textSearch">NÚCLEO DE ORELLANA </b>}>
            ...
            <TreeNode value="parent 20" title={<b className="textSearch">NÚCLEO DE PASTAZA </b>}>
            ...
            <TreeNode value="parent 21" title={<b className="textSearch">NÚCLEO DE PICHINCHA </b>}>
            ...
            <TreeNode value="parent 22" title={<b className="textSearch">NÚCLEO DE SANTA ELENA </b>}>
            ...
            <TreeNode value="parent 23" title={<b className="textSearch">NÚCLEO DE SANTO DOMINGO DE LOS TSÁCHILAS</b>}>
            ...
            <TreeNode value="parent 24" title={<b className="textSearch">NÚCLEO DE SUCUMBÍOS</b>}>
            ...
            <TreeNode value="parent 25" title={<b className="textSearch">NÚCLEO DE TUNGURAHUA</b>}>
            ...
            <TreeNode value="parent 26" title={<b className="textSearch">NÚCLEO DE ZAMORA CHINCHIPE </b>}>
