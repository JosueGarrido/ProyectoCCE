...
const Register = ({
    ...
    const onFinish = async( userData ) => {
        ...
        const { name, last_name, email, email_verified_at, password, password_confirmation, identity,
            ...
            secondary_activity, education_level, career_name, studies_institution,social_networks,name_tienda} = userData;
                        ...
                        >
                            ...
                            <Card style={{ margin: 10 }} type="inner" title="TRAYECTORIA ARTÍSTICO / CULTURAL">
                                ...
                                <Card style={{ margin: 10 }} type="inner" title="INFORMACIÓN CULTURAL">
                                    ...
                                    <Form.Item name='name_tienda'
                                               label="Nombre de la tienda"
                                               extra="Por favor ingrese el nombre de la tienda."
                                               rules={ [
                                                   {
                                                       required: true,
                                                       message: 'Ingresa nombre de la tienda'
                                                   }
                                               ] }
                                               hasFeedback
                                    >
                                        <Input prefix={ <EditOutlined /> } placeholder='Nombre de la tienda' />
                                    ...
                                    <Card style={{ margin: 10 }} type="inner" title="Ámbito principal de la actividad cultural">
                                        ...
                                        >
                                            ...
                                            >
                                                <Option value="ARTES ESCÉNICAS (Teatro Danza)">ARTES ESCÉNICAS (Teatro Danza)</Option>
                                                <Option value="ARTES PLÁSTICAS (Pintura, escultura, dibujo, grabado)">ARTES PLÁSTICAS (Pintura, escultura, dibujo, grabado)</Option>
                                                <Option value="ARTES LITERARIAS">ARTES LITERARIAS </Option>
                                                <Option value="ARTES AUDIOVISUALES (Cine y Fotografía)">ARTES AUDIOVISUALES (Cine y Fotografía)</Option>
                                ...
                                <Card style={{ margin: 10 }} type="inner" title="ENLACES WEB"  >
                                    ...
                                    <Card style={{ margin: 10 }} type="inner" title="Registro de enlaces"  >
                                        ...
                                        <Form.Item name='link_type'
                                                   label="Enlace Web"
                                                   extra="Por favor ingrese el enlace"
                                                   rules={ [
                                                       {
                                                           required: true,
                                                           message: 'Ingresa el URL del enlace web'
                                                       }
                                                   ] }
                                                   hasFeedback
                                        >
                                            <Input prefix={ <EditOutlined /> } placeholder='Ingresa el enlace' />

                                        </Form.Item>

                                        <Form.Item name='link_description'
                                                   label="Descripcion Del Enlace Web"
                                                   extra="Por favor ingrese descripcion"
                                                   rules={ [
                                                       {
                                                           required: true,
                                                           message: 'Ingresa descripcion del enlace ingresado'
                                                       }
                                                   ] }
                                                   hasFeedback
                                        >
                                            <Input prefix={ <EditOutlined /> } placeholder='Ingresar descripcion' />
